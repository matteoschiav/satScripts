...
downSatParis = channel.SimpleDownlinkChannel(sat, staParis, wavelength)

downSatDelft = channel.SimpleDownlinkChannel(sat, staDelft, wavelength)

downSatBarcelona = channel.SimpleDownlinkChannel(sat, staBarcelona, wavelength)
...
dirname = 'raja/satSims/'

if satName == 'Micius':
    filename = 'satMiciusPDB.npz'
    figname = 'satMiciusPDB.png'
elif satName == 'Starlink-1013':
    filename = 'satSlPDB.npz'
    figname = 'satSlPDB.png'
elif satName == 'Iridium-113':
    filename = 'satIrPDB.npz'
    figname = 'satIrPDB.png'
elif satName == 'Cosmos-2545':
    filename = 'satGloPDB.npz'
    figname = 'satGloPDB.png'
